 ...
 * @author Brennan Thompson <http://modernizedmedia.com>
 ...
 */
class TableModel extends \MY_Model
{
    /**
    ...
    /**
     *
     * Any methods not specified here will be routed to the db object
     *
     * @param string $method
    ...
    /**
     * Filter an array of data to only contain valid keys that exist
     * in the given database structure
     *
     * @param string $table
     * @param array $data
     * @return array
